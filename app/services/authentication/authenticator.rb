module Authentication
  class Authenticator
    ...
    def call
      ...
      raise Errors::Authentication::Authenticator::InvalidToken
    end
    ...
    def validate_issuer
      raise Errors::Authentication::Authenticator::InvalidToken if decoded_token.iss != Constants::JWT_ISSUER
    end
  end
end
